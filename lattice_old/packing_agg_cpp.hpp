#ifndef PACKING_AGG_CPP_HPP
#define PACKING_AGG_CPP_HPP
...
namespace oit::ist::nws::adhoc_routing{
    class packing_agg{
        ...
        void agg_sig_pack(uint8_t *pack, uint8_t c[SEEDBYTES], polyvecl *z, polyveck *w, uint8_t wlen);
        void agg_sig_unpack(uint8_t *pack, uint8_t c[SEEDBYTES], polyvecl *z, polyveck *w, uint8_t wlen);
